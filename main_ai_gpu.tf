...
data "cloudinit_config" "config" {
  ...
  part {
    ...
    content      = file("${path.module}/userdata/cloudinit.sh")
  }
}
...
resource "null_resource" "this" {
	...
	provisioner "file" {
		source      = "jupyter_notebooks/gradio_with_local_405b_int4_model.ipynb"
		destination = "/home/opc/gradio_with_local_405b_int4_model.ipynb"
 	}
	connection {
		type    	= "ssh"
		user     	= "opc"
